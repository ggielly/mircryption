...
#ifndef lint
static char rcsid[] = "@(#)$Id: psybnc.c,v 1.1.1.1 2005/02/06 12:56:18 hisi Exp $";
#endif
...
main (int argc, char **argv)
{
  ...
  if (pid) {
     ...
     log(LOG_INFO,-1,lngtxt(1008),bversion,pid);
     fprintf( pidfile,"%d\n",pid);
     fclose(pidfile);
     exit (0x0);
  }  
